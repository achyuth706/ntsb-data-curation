...
scientific reproducibility (Duerr et al., 2011). The placeholder DOI
`10.5281/zenodo.placeholder` in `metadata/dataset_metadata.json` should be
replaced with the actual DOI at the time of deposit.
